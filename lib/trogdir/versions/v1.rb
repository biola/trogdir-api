module Trogdir
  module V1
    autoload :AccountEntity, File.expand_path(
      '../v1/entities/account', __FILE__
    )
    autoload :AccountsAPI, File.expand_path('../v1/accounts_api', __FILE__)
    autoload :API, File.expand_path('../v1/api', __FILE__)
    autoload :AddressEntity, File.expand_path(
      '../v1/entities/address', __FILE__
    )
    autoload :AddressesAPI, File.expand_path('../v1/addresses_api', __FILE__)
    autoload :ChangeSyncsAPI, File.expand_path(
      '../v1/change_syncs_api', __FILE__
    )
    ...
    autoload :SyncLogEntity, File.expand_path(
      '../v1/entities/sync_log', __FILE__
    )
    autoload :SyncLogWithChangesetEntity, File.expand_path(
      '../v1/entities/sync_log_with_changeset', __FILE__
    )
  end
end
